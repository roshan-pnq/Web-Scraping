...
dataset_location = os.path.realpath(
...
if input_year > current_year:
    ...
    for year in tqdm(range(input_year, current_year+1)):
        ...
        for div_item in tqdm(movieList):
            ...
            print(str(i) + '.',)
            header = div.findChildren(
                'h3', attrs={'class': 'lister-item-header'})
            print('Movie: ' + str((header[0].findChildren('a'))
